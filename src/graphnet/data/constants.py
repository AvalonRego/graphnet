...
class FEATURES:
    ...
    PONE= ['module_location_x', 'module_location_y', 'module_location_z', 'pmt_orientation_x', 'pmt_orientation_y', 'pmt_orientation_z', 'pmt_location_x', 'pmt_location_y', 'pmt_location_z', 'time']
...
class TRUTH:
    ...
    PONE=['location_x', 'location_y', 'location_z', 'orientation_x',
       ...
       'time', 'type', 'particle_id', 'duration']