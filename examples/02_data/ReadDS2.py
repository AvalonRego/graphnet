...
"""
what i think this script shows it how to load and initialize a model
"""
...
def main(backend: str) -> None:
    ...
    path = '/u/arego/project/Experimenting/data/graphnet_out/Usable'
    pulsemap = "hits"  # Pulse map name for detector data
    truth_table = "records"  # Truth table name for truth values
    ...
    dataloader = torch.utils.data.DataLoader(
        ...
        num_workers=0,  # Set to 0 to run without multiprocessing
