...
# Define paths
DATA_PATH="/u/arego/ptmp_link/MIX10"
SAVE_PATH="/u/arego/ptmp_link/Class/TrainingLoop/MIX10"
mkdir -p "$SAVE_PATH"

srun python3 /u/arego/graphnet/examples/04_training/ModelLoop10.py \
--gpus 0 1 2 3 --num-workers 18 --target type --wandb \
--batch-size 128 --save_path "$SAVE_PATH" --path "$DATA_PATH"
