...
#SBATCH -o /u/arego/graphnet/examples/04_training/job/IceMix.%j.out
#SBATCH -e /u/arego/graphnet/examples/04_training/job/IceMix.%j.err
...
# Define paths
DATA_PATH="/u/arego/ptmp_link/MIX"
SAVE_PATH="/u/arego/ptmp_link/Class/IceMix/MIX_Loop"
mkdir -p "$SAVE_PATH"

srun python3 /u/arego/graphnet/examples/04_training/Training_06.py \
