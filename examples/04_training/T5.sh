...
#SBATCH -o /u/arego/graphnet/examples/04_training/job/RNN.%j.out
#SBATCH -e /u/arego/graphnet/examples/04_training/job/RNN.%j.err
...
SAVE_PATH="/u/arego/ptmp_link/Class/RNN/MIX"
mkdir -p "$SAVE_PATH"

srun python3 /u/arego/graphnet/examples/04_training/Training_05.py \
