...
def main(
    ...
    #model_path = "/u/arego/ptmp_link/Class/train_model_without_configs/dynedge_type_example_wandb/model.pth"
    #model = StandardModel.load(model_path)  # Change "cpu" to "cuda" if using GPU
    ...
    # Get predictions
    additional_attributes =model.target_labels + ["event_no",'record_id']
...
"""
    ...
    parser.add_argument(
        ...
        default=f"/raven/ptmp/arego/R1T4K_EN10_parquet/",
    )
